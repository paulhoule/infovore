...
/*
public class MultiFileTester {
	@Test
	public void naming0001() {
		PartitionFunction stub=new StubPartitionFunction(9);
		MultiFile<T> mf=new LineMultiFile(
				"/testdirectory",
				"baseName",
				".nt.gz",
				stub,
